...
if Rails.env == 'development'
  ...
  foo = Identity.create(email: 'foo@localhost', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
  ...
  bar = Identity.create(email: 'bar@localhost', password: NORMAL_PASSWORD, password_confirmation: NORMAL_PASSWORD, is_active: true)
